...
- **ประสบการณ์แชทครบถ้วน** — เทิร์นที่สตรีมแบบเรียลไทม์พร้อมกางดูการให้เหตุผล, markdown,
  ...
  โหลดประวัติเป็นหน้า ๆ, แนบรูปภาพ
...
- มี [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) ที่กำลังรันอยู่
  (ทดสอบกับเวอร์ชัน `0.1.2-alpha.1`) **0.9.0 ไม่รองรับโปรโตคอล 0.1.1** — รุ่นนั้น
  เปลี่ยนโปรโตคอลแทนที่จะขยาย ดังนั้นแอปกับฮาร์เนสต้องอัปเดตพร้อมกัน ดู
